    ...
    return (
      <div className="spotify-auth">
        <div className="spotify-login-card">
          ...
          <p>Log in to Spotify to play music and ambient sounds directly from the app.</p>
          ...
          <div className="spotify-info">
            <p>⚠️ <strong>Spotify Premium is required</strong> for playback via the API.</p>
            <p>💡 If you don't have an account, register at <a href="https://spotify.com" target="_blank" rel="noopener noreferrer">spotify.com</a></p>
          </div>
        </div>
      </div>
    );
