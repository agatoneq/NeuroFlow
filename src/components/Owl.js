...
function Owl({ width = 100, height = 100 }) {
  return (
    ...
    >
      ...
      <!-- Belly feathers -->
      <path d="M22 45 q10 10 20 0" stroke="#3b4a6b" strokeWidth="2" fill="none" strokeLinecap="round"/>
      <path d="M22 50 q10 10 20 0" stroke="#3b4a6b" strokeWidth="2" fill="none" strokeLinecap="round"/>
    </svg>
  );
}
